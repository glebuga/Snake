...
class Main : Application() {
    ...
    private val foodImages: List<Image> = FOODS_IMAGE.map { path ->
        val imageUrl = this.javaClass.getResource(path)
        Image(imageUrl.toExternalForm())
    }
    ...
    private fun generateFood() {
        while (true) {
            ...
            // Загрузка случайного изображения из foodImages
            foodImage = foodImages.random()
            break
        }
    }
